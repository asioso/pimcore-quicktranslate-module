                            ...
                            if (!langs.includes(null)) {
                                ...
                                if (xmlStr.length > 4500) {
                                    ...
                                    for (var i = 0; i < partsToTranslate.length; i++) {
                                        var settings = createDeeplApiSettings(partsToTranslate[i], langs[0], langs[1]);
                                    ...
                                    quickTranslate(xmlStr, srcSet, langs[0], langs[1], this.element.id, this.translateObject, quickTranslatecreateWindow);
